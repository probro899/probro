...
const sliderDirectory = path.join(process.cwd(), 'build', 'public', 'assets', 'images', 'slider');
const bannerImagesDir = path.join(process.cwd(), 'build', 'public', 'assets', 'images', 'banner');
