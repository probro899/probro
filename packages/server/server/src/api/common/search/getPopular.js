...
export default async () => {
  try {
      ...
      // console.log('indexUserId getPopular search', allIndexUsers);
      const finalVeriFiedBlogs = blogs.filter(b => b.blog.user.type === 'verified');
      return { blogs: finalVeriFiedBlogs || [], users: allIndexUsers };
    });
